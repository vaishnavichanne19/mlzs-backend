...
import { CreateEnquiry, CreateEnquiryform, CreateGuidelines, CreateRules, CreateWithdrawalPolicy, DeleteEnquiryForm, DeleteRules, getallEnquiry, getAllEnquiryform, getallGuidelines, GetAllRules, getallWithdrawalPolicy, getoneEnquiry, getoneGuidelines, GetOneRules, getoneWithdrawalPolicy, updateEnquiry, updateGuidelines, UpdateRules, updateWithdrawalPolicy } from '../ControlAPi/AdmissionApi/Guidelines.js';
...
import { CreateCalendar, CreateExcelEvent, DeleteAllCalendar, DeleteCalendar, GetAllCalendar, UpdateCalendar } from '../CalendarApi/Calendar.js';
...
Rules Method
 *********************************/
route.post("/createrules",  CreateRules);
route.get("/getallrules", GetAllRules);
route.get("/getonerules/:id", GetOneRules);
route.put("/updaterules/:id", UpdateRules);
route.delete("/deleterule/:id", DeleteRules)
 ...
 *********************************/
route.post("/createphotogallery", uploads.array("photo", 10), CreatePhotoGallery);
...
route.put(
  "/updatephotogallery-imageonly/:id/:imageName",
  uploads.fields([{ name: "photo", maxCount: 1 }]),
  updateSinglePhotoInGallery
);
...
route.delete("/deleteallcalendar", DeleteAllCalendar);
...
route.post(
  "/CreateSchoolLabs",
  uploads.array("SchoolLabsimage", 10),
  CreateSchoolLabs
);

route.get("/getallSchoolLabs", getallSchoolLabs);

route.get("/getoneSchoolLabs/:id", getoneSchoolLabs);
...
route.delete("/deleteSchoolLabs/:id", deleteSchoolLabs);
